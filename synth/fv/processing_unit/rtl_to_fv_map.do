...
# Generated on: Sat Mar 22 17:16:41 CET 2025 (Sat Mar 22 16:16:41 UTC 2025)
...
set logfile fv/processing_unit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/processing_unit -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86"
set env(CW_DIR) "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86/lib/chipware"
set CW_DIR      "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/cad/CADENCE_22/GENUS21.15.000-ISR5/tools.lnx86/lib/chipware/sim"
}
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  hdl/aso.v hdl/processing_unit.v hdl/classifier.v
elaborate_design -golden -root {processing_unit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/processing_unit/fv_map.v.gz
elaborate_design -revised -root {processing_unit}
...
#add_name_alias fv/processing_unit/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.processing_unit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.processing_unit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.processing_unit.rtl.fv_map.rpt
