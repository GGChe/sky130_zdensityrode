...
# Generated on: Thu Mar 20 23:14:30 CET 2025 (Thu Mar 20 22:14:30 UTC 2025)
...
set logfile fv/mult_seq/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
set_system_mode lec
write_compared_points noneq.compared_points.mult_seq.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mult_seq.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mult_seq.rtl.fv_map.rpt
